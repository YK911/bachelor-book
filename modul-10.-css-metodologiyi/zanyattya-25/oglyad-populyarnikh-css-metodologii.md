...
Існує безліч методологій, наприклад [SMACSS](http://smacss.com/), [SUITCSS](http://suitcss.github.io/), [Atomic CSS](https://acss.io/), [BEM](https://en.bem.info/methodology/quick-start/) та інші. Всі вони спрямовані на організацію структури стилів, однорідність селекторів, іменування класів, скорочення дублювання стилів і спрощення взаємодії між розробниками. Деякі методології, наприклад [BEM](https://en.bem.info/methodology/quick-start/), простіші для розуміння і адаптації в проекті, особливо для новачків.
